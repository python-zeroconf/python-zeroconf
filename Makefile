...
test:
	pytest -v zeroconf/test.py zeroconf/test_aio.py

test_coverage:
	pytest -v --cov=zeroconf --cov-branch --cov-report html --cov-report term-missing zeroconf/test.py zeroconf/test_aio.py
